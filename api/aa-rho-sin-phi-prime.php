...
/**
 * Calculates the quantity ρ sin Φ' (rho sin phi prime) of a latitude
 *
 ...
 * @return float            The quantity ρ sin Φ'
 */
function aa_rho_sin_phi_prime($latitude, $height, $is_radian = false)
{
    ...
    $rho_sin_phi_prime = $radius_ratio * sin($u) + $height / 6378140 * sin($latitude);

    return $rho_sin_phi_prime;
}
