...
/**
 * Calculates the Julian day of a date in the Gregorian calendar
 *
 ...
 */
function aa_gregorian_date_to_julian_day($year, $month, $day)
{
    if ($month <= 2) {
        $year--;
        $month += 12;
    ...
    $A = aa_int($year / 100);
    $B = 2 - $A + aa_int($A / 4);
    $julian_day = aa_int(365.25 * ($year + 4716)) + aa_int(30.6001 * ($month + 1)) + $day + $B - 1524.5;
